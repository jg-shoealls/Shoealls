...
class WearGaitDataset(Dataset):
    ...
    def __init__(self, imu_windows, pressure_windows, labels, biomarker_vectors=None):
    ...
    def __getitem__(self, idx: int) -> dict[str, torch.Tensor]:
        ...
        if hasattr(self, "biomarker_vectors") and self.biomarker_vectors is not None:
            res["biomarkers"] = torch.tensor(self.biomarker_vectors[idx], dtype=torch.float32)
        return res
