...
class CrossModalAttentionFusion(nn.Module):
    ...
    def forward(self, modality_features: list[torch.Tensor]) -> torch.Tensor:
        ...
        # Optimization: Set need_weights=False to save computation and memory since we discard weights.
        # This enables optimized attention backends like FlashAttention.
