...
class CrossModalAttentionFusion(nn.Module):
    ...
    def forward(self, modality_features: list[torch.Tensor]) -> torch.Tensor:
        ...
        # Optimization: need_weights=False skips calculating attention weights we don't use,
        # saving memory/compute and enabling optimized backends like FlashAttention.
