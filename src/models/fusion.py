...
class CrossModalAttentionFusion(nn.Module):
    ...
    def forward(self, modality_features: list[torch.Tensor]) -> torch.Tensor:
        ...
        # Optimization: set need_weights=False to skip computing/allocating attention weights
        # when they are discarded, enabling optimized backends like FlashAttention.
