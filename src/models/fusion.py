...
class CrossModalAttentionFusion(nn.Module):
    ...
    def forward(self, modality_features: list[torch.Tensor]) -> torch.Tensor:
        ...
        # Bolt Optimization: Setting need_weights=False skips O(N^2) attention weight allocation,
        # speeding up computation and allowing optimized backends like FlashAttention to be used.
