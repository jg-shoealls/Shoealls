...
class CrossModalAttentionFusion(nn.Module):
    ...
    def forward(self, modality_features: list[torch.Tensor]) -> torch.Tensor:
        ...
        # Optimization: need_weights=False skips attention weight computation and memory
        # allocation since they are unused, enabling optimized backends like FlashAttention.
