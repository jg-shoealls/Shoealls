...
class CrossModalAttentionFusion(nn.Module):
    ...
    def forward(self, modality_features: list[torch.Tensor]) -> torch.Tensor:
        ...
        # Bolt optimization: Set need_weights=False to prevent unnecessary
        # computation/memory allocation, enabling optimized attention backends
        # (like FlashAttention) since the weights are discarded.
...
class CrossAttentionBlock(nn.Module):
    ...
    def forward(self, query: torch.Tensor, context: torch.Tensor) -> torch.Tensor:
        ...
        # Bolt optimization: Set need_weights=False to prevent unnecessary computation
        # and enable optimized attention backends since weights are discarded.
