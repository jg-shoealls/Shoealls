...
class CrossModalAttentionFusion(nn.Module):
    ...
    def forward(self, modality_features: list[torch.Tensor]) -> torch.Tensor:
        ...
        # Optimization: Set need_weights=False since attention weights (_) are discarded.
        # This prevents unnecessary memory allocation and enables optimized backends (e.g., FlashAttention).
