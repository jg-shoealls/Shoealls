...
class CrossModalAttentionFusion(nn.Module):
    ...
    def forward(self, modality_features: list[torch.Tensor]) -> torch.Tensor:
        ...
        # Bolt Optimization: need_weights=False skips computing and returning attention
        # weights, preventing unnecessary memory allocation and enabling FlashAttention
...
class CrossAttentionBlock(nn.Module):
    ...
    def forward(self, query: torch.Tensor, context: torch.Tensor) -> torch.Tensor:
        ...
        # Bolt Optimization: need_weights=False avoids unused attention weight computation
