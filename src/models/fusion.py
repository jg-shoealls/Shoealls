...
class CrossModalAttentionFusion(nn.Module):
    ...
    def forward(self, modality_features: list[torch.Tensor]) -> torch.Tensor:
        ...
        # Optimization: Pass need_weights=False to avoid computing attention weights,
        # which reduces memory usage and enables optimized backends like FlashAttention
