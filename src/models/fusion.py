...
class CrossModalAttentionFusion(nn.Module):
    ...
    def forward(self, modality_features: list[torch.Tensor]) -> torch.Tensor:
        ...
        # Bolt optimization: need_weights=False skips computing and allocating O(B * num_heads * N^2)
        # attention weights matrix, enabling optimized backends like FlashAttention.
...
class CrossAttentionBlock(nn.Module):
    ...
    def forward(self, query: torch.Tensor, context: torch.Tensor) -> torch.Tensor:
        ...
        # Bolt optimization: need_weights=False skips computing attention weights, saving memory and time
