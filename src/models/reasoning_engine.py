...
class CrossModalEvidenceCollector(nn.Module):
    ...
    def forward(
        ...
        # Optimization: cross_attn_weights are unused, rename unpacking target to `_`.
        # Set need_weights=False to prevent unnecessary computation and memory allocation,
        # enabling optimized attention backends (like FlashAttention).
