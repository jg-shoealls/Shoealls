...
class CrossModalEvidenceCollector(nn.Module):
    ...
    def forward(
        ...
        # ⚡ Bolt: Set need_weights=False to prevent unnecessary computation and memory allocation
        # for attention weights that are discarded, enabling optimized attention backends (e.g. FlashAttention).
