...
class CrossModalEvidenceCollector(nn.Module):
    ...
    def forward(
        ...
        # Optimization: need_weights=False prevents unnecessary computation and memory allocation
        # since cross_attn_weights is unused downstream. Unpacking target safely renamed to `_`.
