...
class CrossModalEvidenceCollector(nn.Module):
    ...
    def forward(
        ...
        # ⚡ Optimization: Set need_weights=False as we don't use attention weights downstream.
        # This prevents unnecessary memory allocation and enables optimized backends like FlashAttention.
