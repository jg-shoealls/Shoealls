...
def plot_gait_profile_deviation(
    ...
    for m in metrics:
        if m in session_features and m in baseline_means:
            ...
            plot_labels.append(get_feature_korean.get(m, get_feature_korean(m)))
...
def plot_trend_dashboard(
    ...
    get_feature_korean = {"injury_risk": "부상 위험도", "overall_deviation": "개인 기준 편차"}
    ...
    for idx, metric in enumerate(available):
        ...
        # Annotation
        kr_name = get_feature_korean.get(metric, metric)
