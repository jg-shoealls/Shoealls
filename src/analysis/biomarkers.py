...
BIOMARKER_DEFINITIONS = {
    ...
    "gait_speed": {
        ...
        "diseases": ["파킨슨병", "뇌졸중", "치매", "근감소증", "말초동맥질환"],
    ...
    "cop_sway": {
        ...
        "diseases": ["소뇌 실조증", "전정기관 장애", "다발성경화증", "말초신경병증"],
        "meaning_low": "",
    ...
    "heel_pressure_ratio": {
        ...
        "diseases": ["당뇨 신경병증", "말초동맥질환", "척추관협착증"],
    ...
    "arch_index": {
        ...
        "diseases": ["당뇨 신경병증", "류마티스 관절염", "샤르코-마리-투스병"],
    ...
    "trunk_sway": {
        ...
        "diseases": ["소뇌 실조증", "전정기관 장애", "파킨슨병", "척추관협착증"],
        "meaning_low": "",
