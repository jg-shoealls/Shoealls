...
from src.data.har_dataset import prepare_har_window, synthetic_har_dataset
...
def test_har_window_dataset_item_shape():
    dataset = synthetic_har_dataset(
        num_samples=12, channels=6, sequence_length=128, num_classes=3
    )
    item = dataset[0]
