...
class TestClassify:
    def test_classify_returns_valid_class(self, client, normal_sensor):
        ...
        valid_classes = {
            "normal", "parkinsons", "stroke", "diabetic_neuropathy",
            "cerebellar_ataxia", "osteoarthritis", "dementia", "cerebral_hemorrhage",
            "cerebral_infarction", "disc_herniation", "rheumatoid_arthritis"
        }
